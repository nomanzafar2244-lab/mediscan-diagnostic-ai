...
The current model was trained and evaluated using a held-out test set.
...
These metrics are generated by the included training pipeline and are intended to demonstrate the machine-learning workflow of this portfolio project.
